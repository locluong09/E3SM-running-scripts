...
export COMPILER=gnu
export MACH=pm-cpu
export CASE_NAME=WUS_dynamic_shape_spinup_1980_2018
...
./xmlchange NTASKS=2048,STOP_N=38,STOP_OPTION=nyears,JOB_WALLCLOCK_TIME="10:00:00",RUN_STARTDATE="1980-01-01",REST_N=10,REST_OPTION=nyears
./xmlchange DATM_MODE="CLMNLDAS2",DATM_CLMNCEP_YR_START='1980',DATM_CLMNCEP_YR_END='2017'
